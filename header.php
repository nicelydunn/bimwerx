...
<div id="page" class="site">
	...
	<header class="bg-white flex justify-between px-4 py-2 gap-8 items-center top-0 fixed z-[99] w-full border-b border-gray-100">
		<div class="lg:order-1"><a href="/" aria-label="BIMWERX Homepage"><img class="h-14 w-auto" src="<?php echo get_template_directory_uri(); ?>/assets/images/bimwerx-logo.png" alt=""></a></div>
